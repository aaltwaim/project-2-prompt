...
class CollectiblesTest < ApplicationSystemTestCase
  ...
  test "creating a Collectible" do
    ...
    fill_in "Current bid", with: @collectible.current_bid
    fill_in "Img", with: @collectible.img
    fill_in "Mintage", with: @collectible.mintage
    fill_in "Name", with: @collectible.name
