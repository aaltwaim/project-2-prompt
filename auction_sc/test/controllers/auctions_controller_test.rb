...
class AuctionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create auction" do
    assert_difference('Auction.count') do
      post auctions_url, params: { auction: { collectible_id: @auction.collectible_id, current_bidding: @auction.current_bidding, number_of_bidding: @auction.number_of_bidding, previous_bidding: @auction.previous_bidding } }
    end
  ...
  test "should update auction" do
    patch auction_url(@auction), params: { auction: { collectible_id: @auction.collectible_id, current_bidding: @auction.current_bidding, number_of_bidding: @auction.number_of_bidding, previous_bidding: @auction.previous_bidding } }
